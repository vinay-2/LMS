    ...
    <div className="container mt-3">
      <div className="row align-items-center">
        ...
        <div className="col-md-8">
          <h3>Course title</h3>
          <p>Master Swift, Apple’s powerful programming language for iOS, macOS, and watchOS development. This course walks you through Swift basics, UI design, and app functionality. Whether you're an aspiring developer or looking to create your own app, Swift makes coding intuitive and fun..</p>
