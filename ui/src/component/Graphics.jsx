    ...
    <div className="container mt-3">
      <div className="row align-items-center">
        ...
        <div className="col-md-8">
          <h3>Course</h3>
          <p>Unlock your creativity with Graphic Design, mastering tools like Adobe Photoshop, Illustrator, and Canva. This course covers design principles, typography, and branding to create professional visuals. Perfect for beginners or creatives seeking to expand their design skillset..</p>
