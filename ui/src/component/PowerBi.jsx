    ...
    <div className="container mt-3">
      <div className="row align-items-center">
        ...
        <div className="col-md-8">
          <h3>Course</h3>
          <p>Unlock the potential of your data with Power BI, Microsoft's premier business intelligence tool. This course teaches you how to create interactive dashboards, connect to various data sources, and gain actionable insights. From beginner-friendly concepts to advanced analytical techniques, you’ll learn to visualize data like a pro and drive data-driven decision-making..</p>
