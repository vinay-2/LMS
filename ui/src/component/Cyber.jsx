    ...
    <div className="container mt-3">
      <div className="row align-items-center">
        ...
        <div className="col-md-8">
          <h3>Course title</h3>
          <p>Learn how to secure systems and data in the ever-evolving digital landscape. This course covers cybersecurity principles, ethical hacking, and threat prevention techniques. Gain hands-on experience and become a defender against cyber threats in this high-demand field..</p>
