    ...
    <div className="container mt-3">
      <div className="row align-items-center">
        ...
        <div className="col-md-8">
          <h3>Course title</h3>
          <p>Step into the future with Artificial Intelligence, where machines learn and adapt like humans. This course covers AI fundamentals, machine learning, neural networks, and practical applications. Perfect for beginners, it equips you to build smart systems and solve complex problems in innovative ways..</p>
