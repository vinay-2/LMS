    ...
    <div className="container mt-3">
      <div className="row align-items-center">
        ...
        <div className="col-md-8">
          <h3>Course title</h3>
          <p>Learn Salesforce, the leading CRM platform that revolutionizes how businesses interact with customers. This course takes you through Salesforce basics, workflows, and advanced tools like automation and analytics. Whether you're new to CRM or want to become a Salesforce expert, this course will set you apart..</p>
