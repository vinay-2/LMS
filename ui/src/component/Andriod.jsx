    ...
    <div className="container mt-3">
      <div className="row align-items-center">
        ...
        <div className="col-md-8">
          <h3>Course title</h3>
          <p>Dive into Android app development with Android Studio, Google’s official Integrated Development Environment (IDE). This course teaches you app design, Java/Kotlin programming, and deployment on the Play Store. Build functional, engaging apps and start your journey as a mobile developer..</p>
