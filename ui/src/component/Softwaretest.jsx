    ...
    <div className="container mt-3">
      <div className="row align-items-center">
        ...
        <div className="col-md-8">
          <h3>Course title</h3>
          <p>Learn the essentials of software testing, from manual techniques to advanced automation tools. This course covers testing types, methodologies, and frameworks to ensure software reliability and performance. Perfect for aspiring QA professionals or developers seeking to master quality assurance practices..</p>
